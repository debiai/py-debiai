...
wine_block_structure = [
    ...
    },
    {
        ...
        "groundTruth": [{"name": "quality", "type": "number"}],
    },
]
...
debiai_model_2 = debiai_project.create_model("Model 2", {"Metadata title": "meta data"})
...
results_dict = {
    "Alsace": {  # Block 1 : Region
        ...
        2: {"b_65464": [6, 0], "b_65465": [4, 2], "b_65466": [4, -1]},
    }
}
